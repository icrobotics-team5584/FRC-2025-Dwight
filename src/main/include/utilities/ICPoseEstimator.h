// language: cpp
// filepath: /c:/src/FRC-2025-Dwight/src/main/include/utilities/ICPoseEstimator.h
...
class ICPoseEstimator {
 public:
   ...
   *     less.
   */
  ICPoseEstimator(frc::Kinematics<WheelSpeeds, WheelPositions>& kinematics,
                frc::Odometry<WheelSpeeds, WheelPositions>& odometry,
   ...
   */
  void ResetPosition(const frc::Rotation2d& gyroAngle,
                     const WheelPositions& wheelPositions, const frc::Pose2d& pose) {
   ...
   */
  void ResetTranslation(const frc::Translation2d& translation) {
   ...
   */
  void ResetRotation(const frc::Rotation2d& rotation) {
   ...
   */
  frc::Pose2d GetEstimatedPosition() const { return m_poseEstimate; }
   ...
   * empty).
   */
  std::optional<frc::Pose2d> SampleAt(units::second_t timestamp) const {
   ...
   */
  void AddVisionMeasurement(const frc::Pose2d& visionRobotPose,
    ...
    frc::Twist2d scaledTwist{units::meter_t{k_times_twist(0)},
  ...
  void AddVisionMeasurement(
      const frc::Pose2d& visionRobotPose, units::second_t timestamp,
      const wpi::array<double, 3>& visionMeasurementStdDevs) {
    SetVisionMeasurementStdDevs(visionMeasurementStdDevs);
   ...
   */
  frc::Pose2d Update(const frc::Rotation2d& gyroAngle,
   ...
   * @return The estimated pose of the robot in meters.
   */
  frc::Pose2d UpdateWithTime(units::second_t currentTime,
 ...
 private:
  ...
  frc::Odometry<WheelSpeeds, WheelPositions>& m_odometry;
  wpi::array<double, 3> m_q{wpi::empty_array};
  Eigen::Matrix3d m_visionK = Eigen::Matrix3d::Zero();

  // Maps timestamps to odometry-only pose estimates
  frc::TimeInterpolatableBuffer<frc::Pose2d> m_odometryPoseBuffer{kBufferDuration};
