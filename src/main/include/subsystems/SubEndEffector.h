...
class SubEndEffector : public frc2::SubsystemBase {
 ...
 private:
  ...
  ICSparkFlex _endEffectorMotor{canid::ENDEFFECTOR_MOTOR, 65_A};
  ...
  MechanismCircle2d _endEffectorMechLateralRoller{_endEffectorMechBody, "lateralRoller", 0.025, 0_deg};
};