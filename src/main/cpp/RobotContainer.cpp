...
void RobotContainer::ConfigureBindings() {
  ...
  _driverController.RightBumper().WhileTrue(SubDrivebase::GetInstance().DriveToPose([] {return frc::Pose2d{3.00_m, 4.025_m, -90_deg};}, 1.0)); // Drive to coral right station
  _driverController.LeftBumper().WhileTrue(SubDrivebase::GetInstance().DriveToPose([] {return frc::Pose2d{3.00_m, 4.025_m, -90_deg};}, 1.0)); // Score right side L1
