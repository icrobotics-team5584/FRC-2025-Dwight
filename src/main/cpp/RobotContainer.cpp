...
void RobotContainer::ConfigureBindings() {
  _driverController.A().OnTrue(SubClimber::GetInstance().StowClimber());
  _driverController.B().OnTrue(SubClimber::GetInstance().Climb());
  _driverController.X().OnTrue(SubClimber::GetInstance().ClimberAutoReset());
  ...
  // _operatorController.RightTriger().OnFalse(SubEndEffector::GetInstance().StopMotor());
